...
response = requests.get('https://api.openweathermap.org/data/2.5/forecast?q=kiev,ua&&units=metric&appid='+token)
...
res = es.index(index="kievapi", id=5, body=kievWeather)
print(res['result'])